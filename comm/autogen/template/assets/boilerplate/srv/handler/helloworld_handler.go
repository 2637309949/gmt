...
func (h *Handler) {{toTitle .proto.Name}}Add(ctx context.Context, req *{{.name}}.{{toTitle .proto.Name}}AddReq, rsp *{{.name}}.{{toTitle .proto.Name}}AddRes) error {
	logger.Info(ctx, "Received {{toTitle .proto.Name}}Add request")

	marker := timer.NewMark()
	defer marker.Init(ctx, "{{toTitle .proto.Name}}Add")
	...
	if err != nil {
		logger.Errorf(ctx, "{{toTitle .proto.Name}}AddDB %v", err)
		return err
	}
	rsp.Id = data.ID
	return nil
...
func (h *Handler) {{toTitle .proto.Name}}Del(ctx context.Context, req *{{.name}}.{{toTitle .proto.Name}}DelReq, rsp *{{.name}}.{{toTitle .proto.Name}}DelRes) error {
	logger.Info(ctx, "Received {{toTitle .proto.Name}}Del request")

	marker := timer.NewMark()
	defer marker.Init(ctx, "{{toTitle .proto.Name}}Del")
	...
	if err != nil {
		logger.Errorf(ctx, "{{toTitle .proto.Name}}DelDB %v", err)
		return err
	}
	rsp.Id = filter.ID
	return nil
...
func (h *Handler) {{toTitle .proto.Name}}Update(ctx context.Context, req *{{.name}}.{{toTitle .proto.Name}}UpdateReq, rsp *{{.name}}.{{toTitle .proto.Name}}UpdateRes) error {
	logger.Info(ctx, "Received {{toTitle .proto.Name}}Update request")

	marker := timer.NewMark()
	defer marker.Init(ctx, "{{toTitle .proto.Name}}Update")
	...
	if err != nil {
		logger.Errorf(ctx, "{{toTitle .proto.Name}}UpdateDB %v", err)
		return err
	}
	rsp.Id = filter.ID
	return nil
...
func (h *Handler) {{toTitle .proto.Name}}One(ctx context.Context, req *{{.name}}.{{toTitle .proto.Name}}OneReq, rsp *{{.name}}.{{toTitle .proto.Name}}OneRes) error {
	logger.Info(ctx, "Received {{toTitle .proto.Name}}One request")

	marker := timer.NewMark()
	defer marker.Init(ctx, "{{toTitle .proto.Name}}One")
	...
	if err != nil {
		logger.Errorf(ctx, "{{toTitle .proto.Name}}OneDB %v", err)
		return err
	}
	rsp.Id = data.ID
	return nil
...
func (h *Handler) {{toTitle .proto.Name}}Page(ctx context.Context, req *{{.name}}.{{toTitle .proto.Name}}PageReq, rsp *{{.name}}.{{toTitle .proto.Name}}PageRes) error {
	logger.Info(ctx, "Received {{toTitle .proto.Name}}Page request")

	marker := timer.NewMark()
	defer marker.Init(ctx, "{{toTitle .proto.Name}}Page")

...
```shell
sudo mkdir /etc/mongo.d /etc/mysql.d/init-sql /data/mysql /data/mongo/db /data/mongo/log -p
sudo touch /etc/mysql.d/docker-compose.yaml /etc/mongo.d/docker-compose.yaml
sudo chmod -R 777 /data/mysql /etc/mysql.d /data/mongo /etc/mongo.d

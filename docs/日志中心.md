...
services:
  graylog:
    ...
    environment:
    - GRAYLOG_HTTP_EXTERNAL_URI=http://172.30.13.90:9000
    - GRAYLOG_ROOT_TIMEZONE=Asia/Shanghai
    - GRAYLOG_WEB_ENDPOINT_URI=http://172.30.13.90:9000/:9000/api
    - GRAYLOG_ELASTICSEARCH_HOSTS=http://172.30.13.90:9200
    - GRAYLOG_MONGODB_URI=mongodb://172.30.13.90:27017/graylog
